...
def Potential(x, m, softening=None, G=1., theta=1., parallel=False, tree=None):
    ...
    tree -- optional pre-generated kd-tree (default None)
    """
...
def Accel(x, m, softening=None, G=1., theta=1., parallel=False, tree=None):
