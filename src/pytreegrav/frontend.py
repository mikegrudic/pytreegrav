...
def PotentialTarget(pos_target, pos_source, m_source, softening_target=None, softening_source=None, G=1., theta=.7, tree=None, return_tree=False,parallel=False,method='adaptive',quadrupole=False):
...
def AccelTarget(pos_target, pos_source, m_source, softening_target=None, softening_source=None, G=1., theta=.7, tree=None, return_tree=False, parallel=False, method='adaptive',quadrupole=False):
