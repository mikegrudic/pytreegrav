...
![Wall-clock time per particle running ``pytreegrav`` on a sample of $N$ particles from a @plummer distribution for various $N$. Test was run on a single core of an Intel i9 9900K workstation.\label{fig:cputime}](CPU_Time.png){ width=70% }
